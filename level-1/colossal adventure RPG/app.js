...
let enemy = function (type, hitPoints) {
    ...
    this.printEnemy = function () {
        console.log("Oh no! You encounter the " + this.type + " and it has " + this.hitPoints + " hp.")
    }
}
...
console.log('You are in a ☠️Cursed ☠️ Farm☠️ full of monsters. You only have 100hp. There are two weapons: a Hoe and a Shovel. You can only choose one to start this Cursed Farm Adventure. ')

//Choosing a weapon
const weapon = readlineSync.question("\nWhich weapon would you like to use? Type (h) for Hoe, (s) for Shovel': ");
    if (weapon === "h"){
        console.log("You have chosen the Hoe!")
    } else if (weapon === "s"){
        console.log("You have chosen the Shovel!")
    }
        console.log("Let's carefully proceed with the adventure" + ' Farmer ' + playerName + '...\n')
...
while (player.hp > 0 && farmEnemy.hitPoints > 0) {
    ...
    if (pressKey == "f") {
        ...
        if (farmEnemy.hitPoints < 0) {
            console.log("You killed the " + farmEnemy.type);
            upgrade = genNumInRange(20, 40);
            player.hp += upgrade;
            console.log("You now have " + player.hp + " hp.");
            break;
        }

        damage2 = genNumInRange(20, 50);
        player.hp -= damage2;
        console.log("The " + farmEnemy.type + " hit you for " + damage2 + " points.");
        ...
        if (fiftyFifty < 5) {
            ...
            losePoints = genNumInRange(20, 40);
            player.hp -= losePoints;
            console.log("The " + farmEnemy.type + " hit you. You lost " + losePoints + " hp.");
...
console.log("There are no visible enemies.");

}
if (player.hp < 0) {
console.log("The " + farmEnemy.type + " has killed you.")
console.log("Farmer " + playerName + " you have died 🪦 ." + " Your adventure in the ☠️Cursed ☠️ Farm☠️ is over...")
break
