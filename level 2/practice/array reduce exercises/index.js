...
// const arr = [1,2,3]
// const result = arr.reduce(function(final, nums1) {
//     final += nums1
//     return final
// })
// console.log(result)
...
function stringConcat(arr) {
   const result2 = arr.reduce(function(final, nums2){
    return final + "" + nums2
   })
    return result2
}
...
function shoppingSpree(arr) {
   const total = arr.reduce(function(final, finalCost){
    final += finalCost.price
    return final 
   }, 0)
   return total
}
...
function flatten(arr) {
   const together = arr.reduce(function(final, items){
        final.push(...items)
        return final
   })
        return together
...
function voterResults(arr) {
   const voters2 = arr.reduce(function(final, voter){
