...
addForm.addEventListener("submit", function(e) {
    ...
    document.getElementById("add").append(h3)   //The element is the div's id

    console.log(firstNumber + " + " + secondNumber + " = " + result) //to console the result
})
...
subForm.addEventListener("submit", function(e) {
    ...
    const h3 = document.createElement("h3")
    h3.textContent = firstNumber + " - " + secondNumber + " = " + result
    document.getElementById("substract").append(h3)
